...
from custom_components.bms_ble.plugins.daly2_bms import BMS
...
async def test_invalid_response(monkeypatch, wrong_response) -> None:
    ...
    monkeypatch.setattr(
        "custom_components.bms_ble.plugins.daly2_bms.BMS.BAT_TIMEOUT",
        0.1,
    )

    monkeypatch.setattr(
        "tests.test_daly2_bms.MockDalyBleakClient._response",
